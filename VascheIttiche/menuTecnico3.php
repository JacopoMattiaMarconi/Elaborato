...
<br><br><br>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="prodottiTecnico.php" style="font-size:25;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Prodotti&nbsp;&nbsp;&nbsp;&nbsp;<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="vasche.php" style="font-size:25;">Vasche&nbsp;&nbsp;&nbsp;&nbsp;</a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="agenda.php" style="font-size:25; color:red;">Agenda&nbsp;&nbsp;&nbsp;&nbsp;</a>
      </li>
	  <li class="nav-item">
